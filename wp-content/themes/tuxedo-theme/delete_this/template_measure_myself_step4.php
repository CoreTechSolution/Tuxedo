<?php /* Template Name: Measure Myself Step 4 */ ?>
<?php get_header(); ?>
...
<div class="measureMyself innerContent">
    <div class="maincontent">
        ...
        <div class="section group">
            <div class="col span_12_of_12">
                <div id="crumbs">
                	<ul>
                		...
                		<li><a href="#4" class="activeState">STEP 4</a></li>
            ...
            <div class="col span_12_of_12">
                <p>NOW FOR YOUR SHOULDERS AND ARMS</p>
            </div>
        </div>
            ...
            <div class="section group">
                <div class="col span_6_of_12">
                    <div class="measureVideo">
                        <iframe src="https://player.vimeo.com/video/55957709?title=0&amp;byline=0&amp;portrait=0&amp;badge=0&amp;color=ffffff" width="450" height="253" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
                    </div>
                </div>
                <div class="col span_6_of_12">
                    <div class="measureContent">
                        <p>A. SHOULDER MEASUREMENT</p>
                        <p>Be sure to wear a shirt that fits you well. Place the tape where the shoulder and armhole seem to meet and measure across where the neck hits the back.</p>
                        <p>MY SHOULDERS ARE:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="my_shoulder_length" style="width: 50px; display: inline-block;" /> in</p>
