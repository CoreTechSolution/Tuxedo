<?php /* Template Name: My Measurements Summary */ ?>
<?php get_header(); ?>
                 ...
                 <div class="section group">
                    ...
                    <div class="section group">
                        <div class="col span_12_of_12">
                            <div class="buttonLink"><a href="<?php bloginfo('url'); ?>/update-your-measurements">UPDATE YOUR MEASUREMENTS</a></div>
                        </div>
                    </div>
            </div>
	    </div>
