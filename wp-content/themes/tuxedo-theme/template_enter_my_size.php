<?php /* Template Name: Enter My Sizes */ ?>
<?php get_header(); ?>
<div id="innerContent">
	<div class="maincontent">
	    <div class="section group">
	        <div class="col span_12_of_12"> 
                <div class="container bodyprofile">
                    <form method="post" action="<?php bloginfo('url'); ?>/own-sizes">
                    <h1 style="text-align: center;">Submit Your Own Sizes</h1>
                    <p style="text-align: center;">First, let's set-up your body profile</p>
                    <div class="section group">
                    ...
                    <div class="section group">
                        <div class="col span_12_of_12">
                            <div style="text-align: right;"><input type="submit" name="" value="PROCEED TO NEXT STEP" /></div>
                        </div>
                    </div>
                    </form>
                </div>                         
