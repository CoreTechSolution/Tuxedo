...
<table class="order-details">
	<thead>
		<tr>
            ...
            <th class="quantity"><?php _e('Barcode', 'wpo_wcpdf'); ?></th>
		</tr>
	</thead>
	<tbody>
		...
		<tr class="<?php echo apply_filters( 'wpo_wcpdf_item_row_class', $item_id, $wpo_wcpdf->export->template_type, $wpo_wcpdf->export->order ); ?>">
            ...
            <td class="quantity" style="text-align: center;">
                <?php $order_id = $wpo_wcpdf->get_order_number(); ?>
                <?php $product_id = $item['product_id']; ?>
                <?php $barcode_str = $order_id.'-'.$product_id; ?>
                <?php echo generate_barcode($barcode_str); ?>
                <?php echo $barcode_str; ?>
            </td>
		</tr>
